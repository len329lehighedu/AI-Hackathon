    ...
    return (
        <>
            <button
                ...
                className="fixed bottom-6 right-6 bg-lehigh-gold text-lehigh-dark-brown p-4 rounded-full shadow-lg hover:bg-yellow-500 transition-transform transform hover:scale-110 z-50"
