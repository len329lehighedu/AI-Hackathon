...
const LiveChat: React.FC = () => {
    ...
    const ChatWindow = () => (
        ...
        >
            ...
            <div className="p-3 border-t border-brand-secondary flex items-center bg-brand-surface">
                ...
                />
                <button onClick={handleSendMessage} className="bg-brand-primary text-white p-2 rounded-r-md font-bold hover:bg-opacity-90">
                    Send
                </button>
            </div>
        </div>
    ...
    const UsernamePrompt = () => (
        ...
        >
            ...
            />
            <button onClick={handleJoinChat} className="w-full bg-brand-primary text-white p-2 rounded-md font-bold hover:bg-opacity-90">
                Join
            </button>
        </div>
    );
    ...
    return (
        <>
            ...
            {isOpen && (!username ? <UsernamePrompt /> : <ChatWindow />)}
        </>
    );
};
