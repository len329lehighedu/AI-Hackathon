...
export const ALL_COURSES: Course[] = [
    ...
    },
    {
      ...
      sections: [], prerequisites: ['CSE 017'], materials: []
    },
    {
      ...
      credits: 3, subject: 'Engineering',
      reviews: [], sections: [], prerequisites: ['CSE 017'], materials: []
    },
    {
      ...
      reviews: [], sections: [], prerequisites: [], materials: []
    },
    {
      ...
      description: 'Functions and graphs; limits and continuity; derivative, differential, and applications',
      credits: 4, subject: 'Math',
      reviews: [], sections: [], prerequisites: ['MATH 021'], materials: []
    },
    {
      ...
      sections: [], prerequisites: ['MATH 022'], materials: []
    },
    {
      ...
      sections: [], prerequisites: [], materials: []
    },
    {
    ...
    },
    {
      ...
      credits: 3, subject: 'Engineering',
      reviews: [], sections: [], prerequisites: ['CSE 109'], materials: []
    },
    {
      ...
      sections: [], prerequisites: ['CSE 109'], materials: []
    },
     {
      ...
      credits: 3, subject: 'Engineering',
      reviews: [], sections: [], prerequisites: ['CSE 216'], materials: []
    },
    {
      ...
      reviews: [], sections: [], prerequisites: ['ECO 001'], materials: []
    }
  ];
